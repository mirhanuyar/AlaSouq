...
public class UserBrandNewItems {
    ...
    public static void main(String[] args) {
        ...
        public static void clickBrandNewItems() throws InterruptedException {
            WebElement clickBrandNewItems = driver.findElement(By.id("base-category-136"));
            clickBrandNewItems.click();
