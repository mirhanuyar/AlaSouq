...
public class InHomeHelp {
    ...
    public static void clickInHomeHelp() throws InterruptedException {
        WebElement clickInHomeHelp = driver.findElement(By.id("base-category-9112"));
        clickInHomeHelp.click();
    }
    public static void choosesubCategory() throws InterruptedException {
        WebElement chooseSubCategory = driver.findElement(By.id("sub-category-bebek-cocuk-bakicisi"));
        chooseSubCategory.click();
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
        WebElement element = wait.until(ExpectedConditions.elementToBeClickable(By.id("btn-continue-selection")));
        element.click();
