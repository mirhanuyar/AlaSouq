...
public class Tutors {
    ...
    public static void clickTutorsbutton() throws InterruptedException {
        WebElement clickTutorsbutton = driver.findElement(By.id("base-category-8815"));
        clickTutorsbutton.click();
    }
    public static void choosesubCategory() throws InterruptedException {
        WebElement choosesubCategory = driver.findElement(By.id("sub-category-ozel-ders-verenler-bilgisayar"));
