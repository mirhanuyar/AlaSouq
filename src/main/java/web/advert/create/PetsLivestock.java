...
public class PetsLivestock {
    ...
    public static void clickPetsLive() throws InterruptedException {
        WebElement clickPetsLive = driver.findElement(By.id("base-category-9116"));
        clickPetsLive.click();
    }
    public static void choosesubCategory() throws InterruptedException {
        WebElement choosesubCategory = driver.findElement(By.id("sub-category-hayvanlar-alemi-evcil-hayvanlar-kedi-american-shorthair"));
