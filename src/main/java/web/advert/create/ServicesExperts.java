...
public class ServicesExperts {
    ...
    public static void clickServicesExpert() throws InterruptedException {
        WebElement clickServicesExpert = driver.findElement(By.id("base-category-8286"));
        clickServicesExpert.click();
    }
    public static void choosesubCategory()  throws InterruptedException {
        WebElement choosesubCategory  = driver.findElement(By.id("sub-category-gecis-kontrol-sistemleri-alarm-guvenlik-hizmetleri"));
