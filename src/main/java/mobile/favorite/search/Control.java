...
public class Control {
    ...
    public static void favoriteAdvert() throws InterruptedException {
        driver.findElement(By.id("link-favorite-search")).click();
    }

    public static void clickFavoriteSearchText() throws InterruptedException {
        WebElement searchText = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//span[@class='search-name' and text()='favori arama testi']")));
        searchText.click();
    }
