...
public class Blocked {
    ...
    public static void deletedMessage() throws InterruptedException {
        WebElement module = driver.findElement(By.id("btn-mdl-msg"));
        module.click();
        Thread.sleep(1000);
        WebElement deleteButton = driver.findElement(By.xpath("//button[.//span[text()='Block Account Owner']]"));
        deleteButton.click();
    }
